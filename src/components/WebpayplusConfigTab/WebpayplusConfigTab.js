...
import WebpayplusConfigForm from "./WebpayplusConfigForm";
import { Image } from 'primereact/image';

export default function  WebpayplusConfigTab({env, ecommerce, img}) {
    ...
    return (
        <div className="flex flex-column md:flex-row">
            ...
            <div className="md:w-5">
                <WebpayplusConfigForm  env={env} ecommerce={ecommerce} />
            </div>
        </div>
    );
}
